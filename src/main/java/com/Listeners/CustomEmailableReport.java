...
public class CustomEmailableReport implements IReporter{
    ...
    private static String timeZone = "GMT+530";
...
//				writeTableData(decimalFormat.format(millisecondsToSeconds(duration)), "num");
                writeTableData(decimalFormat.format(millisecondsToMinutes(duration)), "num");
...
//			writeTableHeader(decimalFormat.format(millisecondsToSeconds(totalDuration)), "num");
            writeTableHeader(decimalFormat.format(millisecondsToMinutes(totalDuration)), "num");
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex).append("\">")
                            ...
                            .append(resultsCount).append("\">").append(parseUnixTimeToTimeOfDay(end)).append("</td>")
                            .append("<td rowspan=\"").append(resultsCount).append("\">")
    ...
    protected double millisecondsToMinutes(long ms) {
